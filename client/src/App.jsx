...
function AppContent() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="pointer-events-none fixed top-[-200px] left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full opacity-[0.04] blur-[120px]" style={{ backgroundColor: '#C8FF00' }} />
      <Routes>
